export const projects = [
  {
    ...
    description: "This is my first personal website back in the days when i started to learn web development. i used no frontend framework for this website.also you can find cool little projects that i have builded with vanilla js",
      image: '/images/1.png',
      tags: ['Javascript', 'Css', 'Html'],
    source: 'https://github.com/MHJahanbakhsh/portfolio/tree/master',
    visit: 'https://mhjahanbakhsh.github.io/portfolio/index.html',
    id: 0,
  },
  {
...
export const TimeLineData = [
  { year: 2017, text: 'Started my journey as a data analyst', },
  { year: 2018, text: 'switched to Work as a software engineer', },
  { year: 2019, text: 'developed my skills and knowledge in web stack', },
  { year: 2020, text: 'worked on my personal projects and intrests alongside my job', },
